<%-- 
    ...
    Created on : Dec 28, 2018, 2:22:30 PM
    Author     : Dell
--%>
...
<html>
	...
	<i style="color: #5b5b5b;">"If you think you can, you really can"</i>
		...
		<a href=""><img src="../img/admin/posting.png"><br>Tambah Posting</a>
		</div>
		<div class="shortcutHome">
		<a href=""><img src="../img/admin/photo.png"><br>Upload Foto</a>
		</div>
		<div class="shortcutHome">
		<a href=""><img src="../img/admin/halaman.png"><br>Tambah Halaman</a>
		</div>
		<div class="shortcutHome">
		<a href=""><img src="../img/admin/template.png"><br>Pengaturan Template</a>
		</div>
		<div class="shortcutHome">
		<a href=""><img src="../img/admin/quote.png"><br>Tambah QOD</a>
		</div>
		<div class="shortcutHome">
		<a href=""><img src="../img/admin/bukutamu.png"><br>Data Buku Tamu</a>
		</div>
